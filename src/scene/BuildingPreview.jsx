    ...
    >
      <group ref={turnPivotRef} position={[-leafWidth / 2, 0, 0]}>
        <group ref={tiltGroupRef} position={[leafWidth / 2, 0, 0]}>
          <mesh
            position={[-leafWidth / 2 + sashProfile / 2, -leafHeight / 2, 0]}
            castShadow={WINDOW_MEMBER_CAST_SHADOW}
            receiveShadow
          >
          ...
          <mesh
            position={[0, -leafHeight + sashProfile / 2, 0]}
            castShadow={WINDOW_MEMBER_CAST_SHADOW}
            receiveShadow
          >
    ...
    <group ref={wallFaceRef}>
      ...
      {outerFrameProfile > 0.005 && (
        <group>
          ...
          <mesh
            position={[windowCenterX, windowBottomY + outerFrameProfile / 2, sashSurfaceZ]}
            castShadow={WINDOW_MEMBER_CAST_SHADOW}
            receiveShadow
          >
          ...
          <mesh
            position={[windowCenterX, windowBottomY + windowHeight - outerFrameProfile / 2, sashSurfaceZ]}
            castShadow={WINDOW_MEMBER_CAST_SHADOW}
            receiveShadow
          >
            <boxGeometry args={[windowWidth, outerFrameProfile, frameDepth]} />
      ...
      <mesh
        position={[windowCenterX, cillY, cillZ]}
        castShadow={WINDOW_MEMBER_CAST_SHADOW}
        receiveShadow
      >
...
function ScenePostProcessing({ sunFactor }) {
  ...
  const postFxProfile = useMemo(() => {
    if (contextLost) {
      return { enabled: false, useBloomMipmap: false, multisampling: 0 };
    }
  ...
  return (
    <EffectComposer multisampling={postFxProfile.multisampling}>
      <Bloom
  ...
  return (
    <Card className={cardClass}>
      ...
      >
        <Canvas
          shadows
          dpr={effectiveLowPerformance ? [0.75, 1] : [1, 1.2]}
